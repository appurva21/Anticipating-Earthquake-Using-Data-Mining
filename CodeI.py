...
dn5 = deNormalize(dn4, "Magnitude", "MagnitudeLow", "MagnitudeMid", "MagnitudeHigh",  0.28, 0.55)	#0.28 =6.5mw 0.55= 7.5mw
...
filename = ["cluster0.csv", "cluster1.csv", "cluster2.csv"]
for i in range(number_of_clusters):
	clusters[i].to_csv(filename[i], sep=',')
